...
import cn.cust.elec.dao.IElecCommonMsgContentDao;
import cn.cust.elec.dao.IElecCommonMsgDao;
import cn.cust.elec.domain.ElecCommonMsg;
import cn.cust.elec.domain.ElecCommonMsgContent;
...
public class ElecCommonMsgServiceImpl implements IElecCommonMsgService {
	...
	public void save(ElecCommonMsg elecCommonMsg) throws Exception {
		...
		List<String> stationList = cn.cust.elec.utils.StringUtil.getContentByList(stationRun, 50);
		if(stationList!=null && stationList.size()>0){
		...
		List<String> devList = cn.cust.elec.utils.StringUtil.getContentByList(devRun, 50);
		if(devList!=null && devList.size()>0){
